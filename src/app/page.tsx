    ...
    return(
      <div className="mt-[5px]">
        <div className="bg-[#F5F5F5] pt-[10px] pb-[10px]">
          ...
          <p className="text-[11px] text-center text-[#111111] font-[500] mt-[7px]">Download the app to access everything Nike. <strong className="underline cursor-pointer">Get Your Great</strong></p>
        </div>
        ...
        <div>
          ...
          <div className="flex mt-[30px] gap-2 justify-center">
            <button className="bg-[#111111] w-[110.58px] h-[39px] text-[15px] text-center text-[#FFFFFF] rounded-[30px]">Notify Me</button>
            <button className="bg-[#111111] w-[138.16px] h-[39px] text-[15px] text-center text-[#FFFFFF] rounded-[30px]">Shop Air Max</button>
          </div>
        </div>
        <div className="flex justify-between mt-[100px] ml-[50px] mr-[50px] h-[42px] item-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="rounded-[24px] cursor-pointer bg-[#E5E5E5] w-[48px] h-[48px]">
        ...
        <div className="flex ml-[50px] mt-[20px] gap-2 h-[540.36px]">
          <div className="w-[441.36px] h-[510.36px] cursor-pointer">
          ...
          <div className="h-[510.36px] cursor-pointer">
        ...
        <div className="w-[92%] mt-[50px] m-auto">
          ...
          <div className="flex justify-center">
            <button className="bg-[#111111] w-[152.42px] h-[39px] text-[15px] text-center text-[#FFFFFF] rounded-[30px]">Find Your Shoe</button>
          </div>
        </div>
        ...
        <div className="w-[92%] mt-[100px] m-auto">
          ...
          <div className="flex justify-center">
            <button className="bg-[#111111] w-[80.38px] h-[39px] text-[15px] text-center text-[#FFFFFF] rounded-[30px]">Shop</button>
          </div>
        </div>
        ...
        <div className="mt-[50px] mb-[50px] w-[70%] m-auto h-[192px]">
          ...
          <div className="text-[15px] mt-[20px] ml-[-48px] text-[#757575] font-[500] leading-8">
            ...
            <p className="cursor-pointer">Kids' Jordan Shoes</p>
